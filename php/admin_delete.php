  ...
  <h1><center>ADMIN PAGE</center></h1>
    <div class="container">
      ...
      <form class="form-inline" method="post">
        <input class="form-control mr-sm-2" type="text" placeholder="Input the the phone number to delete the account" id='delete' name='delete'>
        <div id="submit">
          ...
          <?php
             ...
             foreach($r as $row) {
               //echo $row['column_name']; // Print a single column data
                 ...
                 <td>$row[$a4]</td>
                 <td>$row[$a5]</td>
                 <td>$row[$a6]</td></tr>";     // Print the entire row data
             }
